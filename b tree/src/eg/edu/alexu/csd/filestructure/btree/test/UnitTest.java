...
import eg.edu.alexu.csd.filestructure.btree.implementation.SearchResult;
...
public class UnitTest {
	...
	public void testindexWebPage() {
		...
		try {
			...
			// not found word
			actual = searchEngine.searchByWordWithRanking("CAt");
	...
	public void testindexDirectorySimple() {
		 ...
		 */
		try {	
			searchEngine.indexDirectory("res\\sub folder 2\\nested folder");
			List<ISearchResult> expected = Arrays
					.asList(new SearchResult[] { new SearchResult("7724107", 4), new SearchResult("7738283", 1) });
			...
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("plACe");
			Collections.sort(actual, new Comparator<ISearchResult>() {
				@Override
				public int compare(ISearchResult o1, ISearchResult o2) {
					return Integer.parseInt(o1.getId()) - Integer.parseInt(o2.getId()) ;
			...
			// not found word
			actual = searchEngine.searchByWordWithRanking("wordNotExistInFiles");
			Assert.assertEquals(0, actual.size());
		} catch (Throwable e) {
			TestRunner.fail("Fail to index directory", e);
		}
	...
	public void testDeleteWebPageUnIndexedWebPage() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays
					.asList(new SearchResult[] { new SearchResult("7697605", 1), new SearchResult("7708256", 1), new SearchResult("7708264", 1) });
			Collections.sort(expected, new Comparator<ISearchResult>() {
				@Override
				public int compare(ISearchResult o1, ISearchResult o2) {
					return Integer.parseInt(o1.getId()) - Integer.parseInt(o2.getId()) ;
			...
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("bEfoRe");
			Collections.sort(actual, new Comparator<ISearchResult>() {
				@Override
				public int compare(ISearchResult o1, ISearchResult o2) {
					return Integer.parseInt(o1.getId()) - Integer.parseInt(o2.getId()) ;
	...
	public void testsearchByMultipleWordWithRanking() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays.asList(new SearchResult[] { new SearchResult("7697611", 1),
					new SearchResult("7702780", 3), new SearchResult("7702859", 1), new SearchResult("7702865", 1),
					new SearchResult("7708241", 1), new SearchResult("7708255", 1), new SearchResult("7708256", 3),
					new SearchResult("7708283", 1), new SearchResult("7708264", 1), new SearchResult("7708295", 2),
					new SearchResult("7708340", 1), new SearchResult("7712147", 2), new SearchResult("7712174", 1),
					new SearchResult("7712204", 9), new SearchResult("7715915", 24), new SearchResult("7720354", 1),
					new SearchResult("7724082", 3), new SearchResult("7724113", 2), new SearchResult("7728556", 1),
					new SearchResult("7728589", 2), new SearchResult("7734114", 1), new SearchResult("7734119", 3),
					new SearchResult("7734122", 5), new SearchResult("7738274", 3), new SearchResult("7742161", 4),
					new SearchResult("7742185", 3) });
			Collections.sort(expected, new Comparator<ISearchResult>() {
				@Override
				public int compare(ISearchResult o1, ISearchResult o2) {
					return Integer.parseInt(o1.getId()) - Integer.parseInt(o2.getId()) ;
			...
			actual = searchEngine.searchByMultipleWordWithRanking("   tHe  is  aRE   	wordNotExistInFiles	");
			Assert.assertEquals(0, actual.size());
