...
import eg.edu.alexu.csd.filestructure.btree.implementation.BTreeImp;
import eg.edu.alexu.csd.filestructure.btree.implementation.SearchEngine;

public class ReflectionHelper {

    public static List<Class<?>> findClassesImplementing (final Class<?> interfaceClass, final Package fromPackage) {
        final List<Class<?>> ans = new ArrayList<Class<?>>();
        //TODO change this when change class name
    	if(interfaceClass == IBTree.class) {
    		ans.add(BTreeImp.class);
    	}else if(interfaceClass == ISearchEngine.class) {
    		ans.add(SearchEngine.class);
    	}
    	return ans;
//    	
